...
graph1 <- ggplot(data = df_cours, aes(x = DateText, y = Pratiquants, group = 1)) +
  ...
  geom_smooth(method = "loess", se = FALSE, linewidth = 0.5, colour = "Peru", alpha = 0.3) +
...
graph2 <- ggplot(data = df_cours, aes(x = Mois, y = Pratiquants)) +
  ...
  geom_jitter(alpha = 0.8, size = 1.5, width = 0.1, height = 0, colour = "darkgoldenrod1") +
